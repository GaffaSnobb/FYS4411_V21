...
double wave_function_3d_no_interaction_with_loop(arma::Mat<double> pos, double alpha, double beta, const int n_particles);
double wave_function_3d_interaction_with_loop(arma::Mat<double> pos, double alpha, double beta, const int n_particles);
